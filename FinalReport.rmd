...
According to this graph, more Black people oppose capital punishment compared to White people and Other who seem to favor capital punishment more.
...
colPerc(table2)
```
The numerical results reaffirm the percentages from the graphical results. This table states that 68% of Whites are in favor, 46% of Blacks are in favor and 55% of Other are in favor. While 32% of Whites, 54% of Blacks and 44% of Other oppose capital punishment. 
...
chisqtestGC(table2)
```
Let's do the pairwise fisher test.
```{r}
...
With more data, everyone is different from everybody else. The fisherXY test was able to show us that the different test groups are different from each other.
